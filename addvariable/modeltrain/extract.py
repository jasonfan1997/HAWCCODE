...
COLUMNS = ["rec.nHit/U/1","rec.CxPE40/F/0.01","rec.PINC/F/0.01","rec.logNNEnergyV2/F/0","rec.disMax/F/0.01","rec.LDFAge/F/0.01"
,"rec.LDFAmp/F/0.01","rec.LDFChi2/F/0.01","rec.nChAvail/U/1","rec.nHitSP20/U/1"]
