...
__version__ = "$Id: plotMercator.py 42999 2018-05-03 20:08:25Z imc $"
...
# Try importing astropy, for --sexagesimal
try:
...
def main():
    ...
    p.add_argument("--contoursstyle", nargs='*',
                   default=None, help="Draw options for contours")
    p.add_argument("--contourswidth", type=float, nargs='*',
                   default=None, help="Draw options for contours")
    p.add_argument("--contourfile", nargs='*',
                   default=None, help="Draw contours from file with RA/Dec pairs")
    ...
    p.add_argument('--sexagesimal', action='store_true',
    ...
    if isFlux:
        ...
        print("Min:                 %11.2e +/- %11.2e (%6.2f, %5.2f)" % (dMin, fluxerrMin, phMin, 90-thMin))
        print("Max:                 %11.2e +/- %11.2e (%6.2f, %5.2f)" % (dMax, fluxerrMax, phMax, 90-thMax))
        ...
        print("Name: %s ,Max:                 %5.2f (%6.2f, %5.2f)" % (args.output,dMax, phMax, 90-thMax))
      ...
      if haveAstropy:
        ...
        if False:
          ...
          def degrees_to_ddmmss(dec):
              return Angle(dec,u.degree).to_string(unit=u.degree, fields=2)
